...
public class DbManagertestSuite {
    ...
    public void testConnect() throws SQLException {
        ...
        //Then
        Assert.assertNotNull(dbManager.getConnnection());
    }
    ...
    public void testSelectUsersAndPost() throws SQLException {
        ...
        DbManager dbManager = DbManager.getInstance();
        //When
        String sqlQuery = ("SELECT U.FIRSTNAME, U.LASTNAME, COUNT(*) FROM POSTS P, USERS U WHERE P.USER_ID = U.ID GROUP BY P.USER_ID HAVING COUNT(*) >= 2;");
        Statement statement = dbManager.getConnnection().createStatement();
        ResultSet rs = statement.executeQuery(sqlQuery);
